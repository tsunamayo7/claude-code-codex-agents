...
claude-code-codex-agentsは、Claude(Opus 4.6)が書いたコードをGPT-5.4がレビューする仕組み。
...
claude-code-codex-agents開発で一番驚いたこと。
...
claude-code-codex-agents v0.2.0 の実測値:
...
claude-code-codex-agents: https://github.com/tsunamayo7/claude-code-codex-agents
...
claude-code-codex-agentsは、Claude CodeがCodex CLIに仕事を頼んで、その「仕事報告書」を受け取るMCPサーバー。
...
個人開発プロジェクト claude-code-codex-agents をGitHub公開しました。
